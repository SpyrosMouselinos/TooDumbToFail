...
parser.add_argument("--image_dir", type=str, default=os.path.join(server_path, 'avqa-frames-1fps/'))
...
parser.add_argument("--preprocess_batch_size", type=int, default=1)
...
parser.add_argument("--label_train", type=str,
                    default="/home/spyros/Desktop/TooDumbToFail/pstp_net/dataset/split_que_id/perception_train.json",
                    help="train csv file")
parser.add_argument("--label_val", type=str,
                    default="/home/spyros/Desktop/TooDumbToFail/pstp_net//dataset/split_que_id/perception_valid.json",
                    help="val csv file")
parser.add_argument("--label_test", type=str,
                    default="/home/spyros/Desktop/TooDumbToFail/pstp_net//dataset/split_que_id/perception_test.json",
                    help="test csv file")
...
parser.add_argument("--model_save_dir", type=str, default='/runs/models_blip/',
                    help="model save dir")
...
parser.add_argument("--use_mixed", type=bool, default=False, metavar='use_mixed'
                    )
